  ...
  return (
    <>
      <footer
        className={
          (props.absolute
            ? "absolute w-full bottom-0 bg-coolGray-800"
            : "relative") + " pb-6"
        }
      >
        <div className="container mx-auto px-4">
          <hr className="mb-6 border-b-1 border-coolGray-600" />
            ...
            <div className="w-full md:w-4/12 px-4">
              <div className="text-sm text-coolGray-500 font-semibold py-1 text-center md:text-left">
                ...
                <a
                  ...
                  className="text-white hover:text-coolGray-300 text-sm font-semibold py-1"
                >
                  Creative Tim
                </a>
              </div>
            ...
            <div className="w-full md:w-8/12 px-4">
              <ul className="flex flex-wrap list-none md:justify-end  justify-center">
                <li>
                  <a
                    href="https://www.creative-tim.com?ref=nnjs-footer-small"
                    className="text-white hover:text-coolGray-300 text-sm font-semibold block py-1 px-3"
                  >
                    Creative Tim
                  </a>
                </li>
