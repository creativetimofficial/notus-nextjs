				...
				<p className="section">
				 ...
				 <p className="section">
				 	...
				 	Policy has been created with the help of the 
				 	 Terms Feed Privacy Policy Generator.
				 </p>
				 <br/>
				 ...
				 <br/>
				 <h2 className="sech">Definitions</h2>
				 ...
				 <ul>
					...
					<li>
						<p className="section">
							<strong>Application</strong> refers to QL Keyword Research, the software program 
					...
					<li>
						<p className="section">
							<strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, 
								&quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to QL Keyword Research.
						</p>
					</li>
					<li>
						<p className="section">
					...
					<h1 className="post-title sech">Collecting and Using Your Personal Data</h1>
					...
					<br/>
					<h2 className="sech">Use of Your Personal Data</h2>
					<br/>
					<p>
					...
					<ul>
						...
						<li>
							<p className="section">
								...
								products, items or services You have purchased or of any other contract with 
					...
					<p className="section">We may share Your personal information in the following situations:</p>
					<br/>
					<ul>
						<li>
					...
					<h2 className="sech">Retention of Your Personal Data</h2>
					<p className="section">
					...
					<br/>
					<h2 className="sech">Transfer of Your Personal Data</h2>
					<p className="section">
					...
					<br/>
					<h2 className="sech">Delete Your Personal Data</h2>
					<p className="section">
					...
					<br/>
					<h2 className="sech">Disclosure of Your Personal Data</h2>
					<br/>
					<h3 className="sec3">Business Transactions</h3>
					<p className="section">
					...
					<br/>
					<h3 className="sec3">Law enforcement</h3>
					<p className="section">
					...
					<br/>
					<h1 className="post-title sech">Children's Privacy</h1>
					<p className="section">
					...
					<br/>
					<h1 className="post-title sech">Links to Other Websites</h1>
					<p className="section">
					...
					<br/>
					<h1 className="post-title sech">Changes to this Privacy Policy</h1>
					<p className="section">
